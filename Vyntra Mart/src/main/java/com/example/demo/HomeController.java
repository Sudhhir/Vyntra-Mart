...
//    	jdbc.execute("update gst.product_details set product_name='nameofpro', gst =gg ,rate=new_rate where product_code='code_pro';"
//    			.replace("new_rate", rate).replace("nameofpro", name).replace("gg",tax).replace("code_pro",code ));
//		return "update";
//	
//	}
//	
